 ...
 */
public class BufferOccupancyAverageReport extends Report implements MessageListener {
	...
	private Map<DTNHost, Integer> messagesBuffer;
	// know the average time messages stay with this host
	private Map<DTNHost, Double> averageTimeInBuffer;
	// list of hosts
	 ...
	 * Constructor.
	 */
	public BufferOccupancyAverageReport() {
		init();
	}
	...
	public void messageTransferred(Message m, DTNHost from, DTNHost to,
		...
		if(!hosts.contains(to))
			hosts.add(to);

		if(!messagesBuffer.containsKey(to))
			messagesBuffer.put(to, 0);
		
		Integer k = messagesBuffer.get(to);
		messagesBuffer.put(to, k+1);
	...
	@Override
	public void done() {
		write("Buffer Occupancy for scenario " + getScenarioName() +
		...
		// System.out.println("hosts are"+ hosts.size());
		///////////////////////////////////////////////////////////////////
		for(DTNHost e: hosts)
		{
